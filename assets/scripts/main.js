...
class ShoppingApp {
  ...
  #products = {
    Potato: { id: 'Potato', name: 'Картопля', image: '🥔', price: 1 },
    Carrot: { id: 'Carrot', name: 'Морква', image: '🥕', price: 1 },
    Eggs: { id: 'Eggs', name: 'Яйця', image: '🥚', price: 1 },
    Peas: { id: 'Peas', name: 'Горошок', image: '🌱', price: 1 },
    Meat: { id: 'Meat', name: "М'ясо", image: '🍖', price: 1 },
    Cheese: { id: 'Cheese', name: 'Сир', image: '🧀', price: 1 },
    Garlic: { id: 'Garlic', name: 'Часник', image: '🧄', price: 1 },
    Salmon: { id: 'Salmon', name: 'Лосось', image: '🐟', price: 1 },
    Lemon: { id: 'Lemon', name: 'Лимон', image: '🍋', price: 1 },
    Greens: { id: 'Greens', name: 'Зелень', image: '🌿', price: 1 },
    Salt: { id: 'Salt', name: 'Сіль', image: '🧂', price: 1 },
    Pork: { id: 'Pork', name: 'Свинина', image: '🥩', price: 1 },
    Biscuit: {
      id: 'Biscuit',
      name: 'Бісквіт',
      image: '🎂',
    ...
    Milk: { id: 'Milk', name: 'Молоко', image: '🥛', price: 1 },
    Bread: { id: 'Bread', name: 'Хліб', image: '🍞', price: 1 },
    Butter: { id: 'Butter', name: 'Масло', image: '🧈', price: 1 },
    Apple: { id: 'Apple', name: 'Яблуко', image: '🍎', price: 1 },
    Banana: { id: 'Banana', name: 'Банан', image: '🍌', price: 1 },
    Grapes: { id: 'Grapes', name: 'Виноград', image: '🍇', price: 1 },
    Pineapple: {
      id: 'Pineapple',
      name: 'Ананас',
      image: '🍍',
